...
MapLookCameraController _look({double min = 22, double distance = 42}) {
  final camera = Camera(
    name: 'zoom',
...
void main() {
  ...
  test('game close zoom hard-stops at 18.92 when min is 22', () {
    expect(kZoomToFocusHold, const Duration(milliseconds: 200));
    final look = _look();
    expect(look.closeLimitDistance, closeTo(18.92, 1e-9));
    look.beginZoom();
    look.zoomByScale(20);
