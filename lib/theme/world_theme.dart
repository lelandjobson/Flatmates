...
class WorldTheme {
  const WorldTheme({
    ...
    this.path = const Color(0xFFE8C9A8),
    this.wall = const Color(0xFFC4A882),
    this.volume = const Color(0xFFF4EFE6),
  ...
  factory WorldTheme._fromPalette(
    ...
    Color path = const Color(0xFFE8C9A8),
    Color wall = const Color(0xFFC4A882),
    Color volume = const Color(0xFFF4EFE6),
